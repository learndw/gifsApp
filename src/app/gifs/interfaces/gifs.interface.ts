...
//Para obtener la interface del objeto con el que se interactua se copia parte de una respuesta en https://app.quicktype.io y se pega en una interfaz en este caso es Gif seria el tipo de respuesta a asignar y searchGifResponse es la respuesta que dara el metodo http
